 ...
 * 【浮标广告】测试
 */
public class BxmFloatAdActivity extends AppCompatActivity implements ADCallback {
    private static final String TAG = BxmFloatAdActivity.class.getSimpleName();
    ...
    private void startLoadAd(GetAdsResponseListApiResult result){
        ...
        adr = ADUtils.getFloatAdByBXM(this,adContainer,"020c269c50a64688ae6c204dd83f572f","807028001005",this);
        adr.load();
    }
